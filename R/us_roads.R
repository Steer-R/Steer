...
#'
#' `us_roads()` download a spatial dataset, using an API connection to TIGER/Line Shapefiles. This dataset include a
...
us_roads <- function(year, state, unified, path, name, file_type, county) {
  require(tidyverse)
  require(tigris)
  require(sf)
